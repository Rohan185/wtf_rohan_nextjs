      ...
      <div className="container mx-auto px-4 z-10 h-full">
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between h-full pt-8 md:pt-16">
          ...
          >
            ...
            >
              <div className="bg-black/20 text-white px-6 py-2 rounded-md font-bold text-base shadow-md flex items-center">
            ...
            >
              Builder&apos;s Rack: <span className="text-black">v0</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-xl max-w-xl mb-8 text-white leading-relaxed"
            >
            ...
            >
              ...
              <a
                href="#tracks"
                className="border border-white text-white px-8 py-3 rounded-md font-bold text-lg hover:bg-white/10 transition-colors duration-300 flex items-center"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="relative w-full h-full">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <svg className="w-full h-full max-w-lg" viewBox="0 0 600 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    />
                    <circle cx="300" cy="200" r="100" stroke="white" strokeWidth="2" opacity="0.6" />
                    <circle cx="300" cy="200" r="50" stroke="white" strokeWidth="2" opacity="0.8" />
                    ...
                    {/* Laptop outline */}
                    <rect x="200" y="170" width="200" height="120" rx="5" stroke="white" strokeWidth="3" />
                    <path d="M180 290H420V300C420 305.523 415.523 310 410 310H190C184.477 310 180 305.523 180 300V290Z" fill="black" fillOpacity="0.3" />
                    
                    {/* People silhouettes */}
                    <circle cx="220" cy="130" r="20" fill="white" fillOpacity="0.8" />
                    <rect x="210" y="150" width="20" height="30" rx="5" fill="white" fillOpacity="0.8" />
                    
                    <circle cx="380" cy="130" r="20" fill="white" fillOpacity="0.8" />
                    <rect x="370" y="150" width="20" height="30" rx="5" fill="white" fillOpacity="0.8" />
                    
                    <circle cx="300" cy="100" r="20" fill="white" fillOpacity="0.8" />
                    <rect x="290" y="120" width="20" height="30" rx="5" fill="white" fillOpacity="0.8" />
                    
                    {/* Connection lines */}
                    <line x1="230" y1="140" x2="290" y2="110" stroke="white" strokeWidth="2" />
                    <line x1="370" y1="140" x2="310" y2="110" stroke="white" strokeWidth="2" />
                    <line x1="300" y1="150" x2="300" y2="170" stroke="white" strokeWidth="2" />
                    
                    {/* Code symbols */}
                    <text x="220" y="220" fill="white" fontFamily="monospace" fontSize="14">{"<code>"}</text>
                    <text x="330" y="220" fill="white" fontFamily="monospace" fontSize="14">{"</code>"}</text>
                    <text x="240" y="250" fill="white" fontFamily="monospace" fontSize="12">{"function hackathon() {"}</text>
                    <text x="260" y="270" fill="white" fontFamily="monospace" fontSize="12">{"return innovation;"}</text>
                    <text x="240" y="290" fill="white" fontFamily="monospace" fontSize="12">{"}"}</text>
                  </svg>
                </div>
                ...
                />
                <motion.div 
                  className="absolute bottom-1/3 left-1/3 w-6 h-6 rounded-full bg-white/20"
