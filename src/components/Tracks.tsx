...
const Tracks = () => {
  ...
  return (
    <section 
      id="tracks" 
      ref={sectionRef}
      className="relative pt-20 pb-16 px-6 mt-10"
    >
      {/* Background elements */}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-16">
          <motion.div
            ...
            className="inline-flex items-center justify-center px-4 py-1 mb-4 rounded-full bg-black/20 border border-white/20"
          >
            <span className="text-white text-sm font-semibold tracking-wider uppercase">Challenge Tracks</span>
          </motion.div>
          ...
          >
            Tracks & <span className="text-black">Problem Statements</span>
          </motion.h2>
          ...
          <motion.div
            ...
            className="h-1 bg-black rounded-full mb-6"
          />
            ...
            {trackData.map((track, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-md bg-black/30 border border-white/20">
                    {track.icon}
                  </div>
                  <div>
                ...
                <div className="absolute top-6 right-4 md:right-6 flex items-center justify-center w-8 h-8 rounded-full bg-black/50 border border-white/30">
